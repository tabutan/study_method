...
<!-- Rについて本はNotionの「じんるい読書記録データベース」に紹介されているので、ここでは割愛し、ネットの情報を紹介する。 -->
...
## Rmarkdownの作成
Rで研究を始めるなら、RファイルではなくRmdファイルにすることを強く勧める。その理由として、結果とその結果に対する自分のコメントを書けることが大きい。初期設定ではSourceペインに結果が表示されてしまう。これが嫌な人は、
