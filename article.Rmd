...
data.frame("Engine" = c("Mendeley", 
           ...
           "備考" = c("割と使われているソフト","ユーザーインターフェースがわかりやすい、一つのGoogleアカウントと紐づけられているので、15GBを超えるとストックに対しても課金されるが、そこまで論文を保存する学生はまずいない。","有料版は高機能だがお高め、無料版のbasicは2GBまで（約1200のPDF）","無料でありながら有能という情報あり")) %>% 
